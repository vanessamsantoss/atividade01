...
import { c as cleanUrl, e as createDefer, i as isAbsolute } from './pathe.M-eThtNZ.DwEga6ro.js';
import { p as parse } from './acorn.C1kjbUFw.js';
import { t as toBuiltin } from './modules.BJuCwlRJ.js';
import { B as BareModuleMocker, n as normalizeModuleId } from './index.hTNFpC24.js';
import 'node:fs';
...
`;
	...
	loadManualMock(url, result) {
		...
		if (isBuiltin(moduleId)) {
			...
			return {
				format: "module",
				source: createManualModuleSource(moduleId, exports),
				shortCircuit: true
			};
		}
