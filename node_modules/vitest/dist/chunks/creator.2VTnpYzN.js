...
import { detectPackageManager, installPackage } from './index.DXQx-kDM.js';
import { y as prompt, z as findConfigFile } from './index.C-uw7tH9.js';
...
import './nativeModuleRunner.J0QLzNtK.js';
import 'node:module';
import 'node:v8';
import 'node:util';
...
import '../traces.js';
import 'obug';
import './resolver.NpfwMKt9.js';
import 'es-module-lexer';
import 'tinyglobby';
import './defaults.D2ip7f-X.js';
import 'magic-string';
import '@vitest/mocker/node';
import 'node:console';
import 'node:stream';
import './offset.Dy-5Fdfn.js';
import './utils.CJ0JImL8.js';
import '#module-evaluator';
import 'picomatch';
import './coverage.CX7NN5s7.js';
import 'node:tty';
import 'node:events';
...
async function updatePkgJsonScripts(pkgJsonPath, vitestScript) {
	if (!existsSync(pkgJsonPath)) await writeFile(pkgJsonPath, `${JSON.stringify({ scripts: { "test:browser": vitestScript } }, null, 2)}\n`, "utf-8");
	else {
