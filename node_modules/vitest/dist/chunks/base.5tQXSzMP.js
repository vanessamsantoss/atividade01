...
import { s as spyModule } from './spy.KLHgXex_.js';
import { r as resolveTestRunner, a as resolveSnapshotEnvironment, d as detectAsyncLeaks, s as setupChaiConfig } from './index.BgwtGYxD.js';
import { l as loadEnvironment, e as emitModuleRunner, a as listenForErrors } from './init.IsjtLXKe.js';
import { Traces } from '../traces.js';
import { V as VitestEvaluatedModules } from './rpc.CJVl3hZH.js';
import { s as startVitestModuleRunner, c as createNodeImportMeta } from './index.hTNFpC24.js';
import { performance as performance$1 } from 'node:perf_hooks';
import { s as startCoverageInsideWorker, a as stopCoverageInsideWorker } from './coverage.AipniaqB.js';
import { i as index, g as globalExpect, v as vi } from './index.DGdajAO2.js';
...
import { s as setupCommonEnv, b as setupEnv } from './setup-common.Ct8rQvjH.js';
...
async function startModuleRunner(options) {
	...
	if (options.state.config.experimental.viteModuleRunner === false) {
		...
		if (options.state.config.experimental.nodeLoader !== false) {
			...
			const { NativeModuleMocker } = await import('./nativeModuleMocker.DwRB4F9R.js');
